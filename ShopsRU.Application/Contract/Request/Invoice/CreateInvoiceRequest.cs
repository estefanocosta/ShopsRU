...
namespace ShopsRU.Application.Contract.Request.Invoice
{
    public class CreateInvoiceRequest
    {
        ...
        {
            return new CreateInvoiceResponse { InvoiceDate = invoice.InvoiceDate, InvoiceId = invoice.Id, SaleNo = invoice.SaleId, SaleDate = invoice.Sale.SaleDate, CustomerName = string.Concat(invoice.Customer.FirstName, " ", invoice.Customer.LastName), NetAmount = invoice.NetAmount, TotalAmount = invoice.TotalAmount, DiscountAmount = invoice.DiscountAmount };
        }


        public ShopsRU.Domain.Entities.Invoice MapToEntity(ApplyDiscountResponse applyDiscount, int customerId, int saleId)
        {
